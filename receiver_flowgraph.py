...
class receiver_flowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "receiver_flowgraph")
        ...
        self._rx_gain_range = qtgui.Range(0, 31.5, 0.5, 10, 200)
        ...
        self._center_freq_range = qtgui.Range(400e6, 4400e6, 1e6, 900e6, 200)
...
def main(top_block_cls=receiver_flowgraph, options=None):
